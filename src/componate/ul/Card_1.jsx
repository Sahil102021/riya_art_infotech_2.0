...
const Card_1 = ({ quote, img, imgname, name, role }) => {
  return (
    <div>
      <div className="w-full h-full flex flex-col max-w-sm mx-auto border border-[var(--bg-color-xxi)] rounded-xl overflow-hidden bg-white shadow-md">
        <div className="w-full h-full px-4 pb-10 pt-3 lg:pt-4 rounded-t-lg  md:px-6 bg-[var(--bg-color-xxi)]">
